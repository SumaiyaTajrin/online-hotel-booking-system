	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="{{route('home')}}" class="nav-link">
              <button type="button" class="btn btn-outline-light">Home</button></a></li>
	          <li class="nav-item active"><a href="{{route('room')}}" class="nav-link">
            <button type="button" class="btn btn-outline-light">Rooms</button></a></li>
	          <li class="nav-item"><a href="{{route('booking')}}" class="nav-link">
            <button type="button" class="btn btn-outline-light">Booking</button></a></li>
	          <li class="nav-item"><a href="{{route('about')}}" class="nav-link">
            <button type="button" class="btn btn-outline-light">About</button></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
    <!-- END nav -->
      ...
      <div class="container">
		...
		<section class="ftco-section ftc-no-pb ftc-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 img-3 d-flex justify-content-center align-items-center" style="background-image: url(frontend/images/bg_2.jpg);">
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb px-0">
			<div class="container-fluid px-0">
				<div class="row no-gutters justify-content-end">
					<div class="col-md-12">
						<div id="home" class="video-hero" style="height: 800px; background-image: url(frontend/images/bg_2.jpg); background-size:cover; background-position: center center;">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Sea Shine</h2>
